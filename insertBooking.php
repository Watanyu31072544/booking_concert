<meta charset="utf-8">
  <?php
    ...
    if($num > 0)
    {
    echo "<script> alert('คุณเพิ่งจองที่นั่งไว้แล้ว ไม่สามารถเลือกที่นั่งได้แล้ว กรุณาเลือกชื่อคอนเสิร์ตใหม่อีกครั้ง หรือยกเลิกจองที่นั่งคอนเสิร์ตของคุณก่อน !'); </script> ";
