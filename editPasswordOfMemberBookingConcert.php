  ...
  if($result){
    ...
    echo "<script> alert ('แก้ไขรหัสผ่านของสมาชิกไม่สำเร็จ เนื่องจากไม่ได้อยู่ในฐานระบบข้อมูล กรุณาลงทะเบียนก่อนเข้าสู่ระบบด้วยนะ'); </script> ";//ระบบฐานข้อมูลมีข้อผิดพลาด
  }
  mysqli_close($db);
  ?>